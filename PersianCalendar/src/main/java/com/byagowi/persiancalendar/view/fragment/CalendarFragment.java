...
public class CalendarFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(
        ...
        Adivery.prepareInterstitialAd(getActivity(), "38b301f2-5e0c-4776-b671-c6b04a612311");

        AdiveryBannerAdView bannerAdd = view.findViewById(R.id.banner_add);

        bannerAdd.setBannerAdListener(new AdiveryAdListener() {
            @Override
    ...
    private int maxSupportedYear = 1403;
