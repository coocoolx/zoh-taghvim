...
public class AppRater {
    ...
    private static final String DEFAULT_TARGET_URI = "bazaar://details?id=com.taghvim.zho";
//    private static final String DEFAULT_TARGET_URI = "https://play.google.com/store/apps/details?id=com.taghvim.zho";
//    private static final String DEFAULT_TARGET_URI = "myket://comment?id=com.taghvim.zho";
    private static final String DEFAULT_TEXT_TITLE = "امتیاز به این برنامه";
    private static final String DEFAULT_TEXT_EXPLANATION = "اگر این برنامه را دوست دارید به آن 5 ستاره بدهید!";
    private static final String DEFAULT_TEXT_NOW = "خیلی خب!";
    private static final String DEFAULT_TEXT_LATER = "بعدا!";
    private static final String DEFAULT_TEXT_NEVER = "نمی پسندم";
    ...
    private void createTargetIntent() {
        mTargetIntent = new Intent(Intent.ACTION_EDIT, Uri.parse(String.format(mTargetUri, mPackageName)));
